...
public class AgregarEditorial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregrar nueva editorial");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Agregar Editorial", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 102, 204))); // NOI18N
    ...
    private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
        if (jtfNombre.getText().trim().isEmpty()
            ...
            ed.setNombre(jtfNombre.getText());
            ed.setDireccion(jtfDireccion.getText());
            ed.setTelefono(jtfTelefono.getText());
            if (ae.agregarEditorial(ed)) {
                JOptionPane.showMessageDialog(null, "Editorial agregado exitosamente!", "En horabuena!", JOptionPane.INFORMATION_MESSAGE);
                limpiar();
            } else {
